...
import EnrollmentsModal from './EnrollmentsModal.vue';
...
<template>
  ...
  <EnrollmentsModal v-model:open="showEnrollmentsModal" title="Enrollments"
    description="Manage the enrollments for this course." :course="course" />
